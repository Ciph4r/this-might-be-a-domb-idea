...
header.style.frontSize = '5em'

const item13 = document.querySelector('#item-13').style.opacity = "0.5";
...
//  const newLi = list.appendChild((document.createElement('li')(document.createTextNode())).setAttribute('id','item-16'))
 

const newLi = list.appendChild(document.createElement('li')).innerText = `Won't get fooled again.`
